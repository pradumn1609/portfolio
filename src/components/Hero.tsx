    ...
    >
      <div className="max-w-4xl mx-auto text-center pt-20">
        ...
        <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
          I help individuals and businesses build clean, responsive, and scalable web applications
          using React, JavaScript, and Node.js. I also leverage AI tools to deliver efficient and
